...
In `page.tsx`, find the Side Quest winner entry and set:

```ts
image: "/hackathon/2026/side-quest/photo.jpg",
// and/or
video: "/hackathon/2026/side-quest/demo.mp4",
```
