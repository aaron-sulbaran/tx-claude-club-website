...
In `page.tsx`, find the NeuroDesign winner entry and set:

```ts
image: "/hackathon/2026/neurodesign/photo.jpg",
// and/or
video: "/hackathon/2026/neurodesign/demo.mp4",
```
